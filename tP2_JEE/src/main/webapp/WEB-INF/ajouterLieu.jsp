...
<body style="background-color:brown;">
	...
	<section style="background-color: beige; padding: 30px;border-radius:20px;" class="container align-self-center col-md-6">
		<div class="row" >
			<H1 style="text-align:center;font-family: fangsong; text-transform: capitalize;" > Ajouter un Lieu </H1>
			<form action="InsererLieuServlet" method="POST">
			  <div class="form-group">
			    <label>ID Lieu</label>
			    <input type="text" name="idL" class="form-control"  placeholder="ID du lieuv...">
			  </div>
			  <br>
			  <div class="form-group">
			    <label>Adresse</label>
