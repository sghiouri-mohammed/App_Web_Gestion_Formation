	...
	<section style="background-color: beige; padding: 30px;border-radius:20px;" class="container align-self-center col-md-11">
		<div class="row" >
			<div class="col-md-5 align-self-center">
				<H1 style="text-align:center;font-family: fangsong; text-transform: capitalize;" > Modifier la formation <c:out value="${ idF }" ></c:out> </H1>
				<form action="UpdateFormationServelt" method="POST">
				  <div class="form-group">
				    <label>ID <c:out value="${idF}"></c:out> </label>
				    <input  type="text" name="idFo" class="form-control"  placeholder="${idF }">
				  </div>
				  <br>
				  <div class="form-group">
				    <label>Theme</label>
